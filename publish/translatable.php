...
/**
 * This file is part of jiumikeji/translatable.
 *
 * @link     https://github.com/jiumikeji/translatable
 * @contact  root@imoi.cn
 * @license  https://github.com/jiumikeji/translatable/blob/master/LICENSE
 */
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Deterjiumi if fallback locales are returned by default or not. To add
    ...
    */
     ...
     */
    'rule_factory' => [
        'format' => \Jiumi\Translatable\Validation\RuleFactory::FORMAT_ARRAY,
        'prefix' => '%',
        'suffix' => '%',
    ],
];
